...
class FakeXPOrb extends Entity
{
    const NETWORK_ID = 69;
    ...
    function onUpdate($currentTick)
    {
        ...
        if ($minDistance < PHP_INT_MAX) {
            ...
            if ($minDistance <= 1.3) {
                ...
                $expectedPos->attack(($damage = mt_rand(1, 4)), new EntityDamageEvent($expectedPos, EntityDamageEvent::CAUSE_MAGIC, $damage));
            }
        }
